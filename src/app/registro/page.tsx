      ...
      <div className="max-w-3xl mx-auto bg-white rounded-[35px] shadow-xl p-10">
        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <div className="text-center flex-1">
            <div className="w-10 h-10 rounded-full bg-[#891C20] text-white flex items-center justify-center mx-auto">
              1
            </div>
        ...
        <div className="space-y-6">
          ...
          <button className="bg-[#891C20] text-white rounded-full px-10 py-4">
            Continuar →
          </button>
