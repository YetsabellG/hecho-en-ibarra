  ...
  return (
    <main className="min-h-screen bg-[#f8f1e7] px-5 py-12 lg:px-8">
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[.85fr_1.15fr] lg:items-center">
        <section className="hidden rounded-[32px] bg-[#6f1519] p-10 text-white shadow-xl lg:block">
        ...
        <section className="rounded-[32px] border border-[#eadbca] bg-[#fffdf9] p-7 shadow-[0_20px_60px_rgba(105,72,45,.12)] sm:p-10">
          <Link href="/" className="text-sm font-black tracking-[.2em] text-[#891C20] lg:hidden">HECHO EN IBARRA</Link>
          <div className="mt-6"><span className="text-xs font-black uppercase tracking-[.22em] text-[#891C20]">Acceso de emprendedor</span><h1 className="mt-3 text-4xl font-black text-[#342821]">Inicia sesión</h1><p className="mt-3 text-[#75685f]">Administra tu negocio, productos y promociones.</p></div>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2"><Link href="/auth/register" className="flex items-center justify-center gap-2 rounded-2xl border border-[#eadbca] px-4 py-3 text-center text-sm font-bold text-[#6f1519] hover:bg-[#f4e7d9]"><Store size={17}/> Crear cuenta de emprendedor</Link><Link href="/explorar" className="flex items-center justify-center gap-2 rounded-2xl border border-[#eadbca] px-4 py-3 text-center text-sm font-bold text-[#6c7d68] hover:bg-[#eef1eb]"><Compass size={17}/> Entrar como visitante</Link></div>
