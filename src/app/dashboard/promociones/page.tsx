...
useEffect(() => {
  ...
  <div className="mt-4 flex items-center gap-2 text-[#C54B43] font-semibold">
  ...
  <Link
    ...
    className="flex-1 text-center bg-[#C54B43] text-white py-3 rounded-xl hover:bg-[#A53C35] transition"
  >
    Editar
  </Link>
